...
public class GenerateComponentDescriptorRdf {
	...
	/**
	 * @param componentPropertyKeyValues
	 *            the componentPropertyKeyValues to set
	 */
	...
	/**
	 * @param componentInputKeyValues
	 *            the componentInputKeyValues to set
	 */
	...
	/**
	 * @param componentOutputKeyValues
	 *            the componentOutputKeyValues to set
	 */
	...
	public String getRdfDescriptor() throws CorruptedDescriptionException {
		...
		String sRights = (componentKeyValues.containsKey("rights")) ? (String) componentKeyValues
				.get("rights").toString()
				: "";
				String sRightsOther = (componentKeyValues.containsKey("rightsOther")) ? (String) componentKeyValues
						.get("rightsOther")
						: "";
						String sCreator = (componentKeyValues.containsKey("creator")) ? (String) componentKeyValues
								.get("creator")
								: "";
								java.util.Date dateCreation = new java.util.Date();
								String sTags = (componentKeyValues.containsKey("tags")) ? (String) componentKeyValues
										.get("tags")
										: "";
										String sFormat = (componentKeyValues.containsKey("format")) ? (String) componentKeyValues
												.get("format")
												: "";
												// String type= getType((String)componentKeyValues.get("mode"));
												String type = (componentKeyValues.containsKey("mode")) ? (String) componentKeyValues
														.get("mode").toString()
														: "";

														// Runnable runnable = (Runnable)componentKeyValues.get("runnable");
														String sRunnable = (componentKeyValues.containsKey("runnable")) ? (String) componentKeyValues
																.get("runnable").toString()
																: "";
																// String sFiringPolicy =
																// getFiringPolicy((String)componentKeyValues.get("firingPolicy"));
																String sFiringPolicy = (componentKeyValues.containsKey("firingPolicy")) ? (String) componentKeyValues
																		.get("firingPolicy").toString()
																		: "";

																		String sLocation = (componentKeyValues.containsKey("location")) ? (String) componentKeyValues
																				.get("location")
																				: "";
																				...
																				java.util.Set<DataPortDescription> setInputs = getDataPortDescription(
																						componentInputKeyValues, model, sBaseURL, sComponentName,
																				"input");

																				java.util.Set<DataPortDescription> setOutputs = getDataPortDescription(
																						componentOutputKeyValues, model, sBaseURL, sComponentName,
																				"output");
																				...
																				ExecutableComponentDescription ecd = new ExecutableComponentDescription(
																						resExecutableComponent, sName, sDescription, sRights, sCreator,
																						dateCreation, sRunnable, sFiringPolicy, sFormat, setContext,
																						resLocation, setInputs, setOutputs, pddProperties, tagDesc,
																						resMode);
	...
	public static java.util.Set<DataPortDescription> getDataPortDescription(
			java.util.Hashtable dataPortKeyValues, Model model,
			String sBaseUrl, String sComponentName, String sDirectionKey)
		...
		if (dataPortKeyValues != null) {
			for (int i = 0, iMax = dataPortKeyValues.size(); i < iMax; i++) {
				java.util.Set<java.util.Map.Entry<String, Object>> keyValueSet = (java.util.Set<java.util.Map.Entry<String, Object>>) dataPortKeyValues
				.get(Integer.toString(i));
				java.util.Iterator<java.util.Map.Entry<String, Object>> iter = (java.util.Iterator<java.util.Map.Entry<String, Object>>) keyValueSet
				.iterator();
				...
				.replaceAll(" ", "-");
				setUpDataPort.add(new DataPortDescription(model
						.createResource(sBaseUrl + sComponentName + "/"
								+ sDirectionKey + "/" + sID), sBaseUrl
								+ sComponentName + "/" + sDirectionKey + "/" + sID,
								name, description));
			}
		}
	...
	@SuppressWarnings("unchecked")
	public static PropertiesDescriptionDefinition getPropertiesDescriptionDefinition(
			java.util.Hashtable propertyKeyValues) {
		...
		if (propertyKeyValues != null) {
			for (int i = 0, iMax = propertyKeyValues.size(); i < iMax; i++) {
				java.util.Set<java.util.Map.Entry<String, Object>> keyValueSet = (java.util.Set<java.util.Map.Entry<String, Object>>) propertyKeyValues
				.get(Integer.toString(i));
				java.util.Iterator<java.util.Map.Entry<String, Object>> iter = (java.util.Iterator<java.util.Map.Entry<String, Object>>) keyValueSet
				.iterator();
				java.util.Hashtable<String, Object> ht = new java.util.Hashtable<String, Object>();
		...
		PropertiesDescriptionDefinition pddProperties = new PropertiesDescriptionDefinition(
				htValues, htDescriptions);
