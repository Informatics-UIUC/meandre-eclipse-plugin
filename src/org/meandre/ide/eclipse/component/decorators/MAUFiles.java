 ...
 *******************************************************************************/
package org.meandre.ide.eclipse.component.decorators;
 ...
 */
public class MAUFiles implements ILightweightLabelDecorator {
	/**
	...
	private String iconPath = "icons/meandre_mau16.gif"; //NON-NLS-1
	...
	public void decorate(Object element, IDecoration decoration) {
		...
		String extn =resource.getFileExtension();
		if(extn!=null){
		if (extn.equals(Activator.MAU_EXTN)){
			URL url = Platform.find(
					Platform.getBundle("org.meandre.ide.eclipse.component"), new Path(iconPath)); //NON-NLS-1
