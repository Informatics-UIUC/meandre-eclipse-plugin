...
public class _CLASS_ implements ExecutableComponent, WebUIFragmentCallback {
	
	@ComponentInput(description="input message", name="message")
	private static final String DATA_IN_1 = "message";
	...
	public void execute(ComponentContext cc) throws ComponentExecutionException, ComponentContextException {
		try {
			...
			sMsg  = cc.getDataComponentFromInput(DATA_IN_1).toString();
